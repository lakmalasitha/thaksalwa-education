...
<div class="column displaybox">
    <nav class="breadcrumb has-arrow-separator has-background-white" aria-label="breadcrumbs">
      <ul>
        ...
        <li class="is-active"><a href="/profile">Teacher Management</a></li>
      </ul>
    </nav>
    ...
    <div class="container">
                ...
                <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4" width="100%">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                      <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" onclick="document.getElementById('Add_teacher').style.display='inline';document.getElementById('remove_students').style.display='none';">Register Teacher</a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link" onclick="document.getElementById('remove_students').style.display='inline';document.getElementById('Add_teacher').style.display='none';">Remove Teacher</a>
                          </li>
                      </ul>
                    </div>
                  </nav>
        ...
        <!-- Add Teacher -->
            <div id="Add_teacher">
                <form method="POST" action='/registerTeacher' enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="field">
                            <p class="control has-icons-left">
                                ...
                                <span class="invalid-feedback" role="alert">
                                    <strong class="has-text-danger">{{ $errors->first('NIC') }}</strong>
                                </span> @endif
                            </p>
                        </div>
                        <div class="my-4"></div>
                        ...
                        <tbody style="text-align: center">
                            @foreach ($teachers as $teacher)
                                ...
                                <center>
                                    <td>
                                        <center>
                                            <form action="/delete/deleteteacher/{{$teacher->id}}" method="post">
                                                @csrf
                                                <input type="hidden" name="id" value="{{$teacher->id}}">
                                                <button class="button is-danger" style="width:100%" onclick="return confirm('Are you sure?')" type="submit">Remove Teacher</button>
                                            </form>
                                            <a href="/teachersProfile/{{$teacher->id}}"><button class="button is-success" style="width:100%">View profile</button></a>
                                        </center>
                                    </td>
                                </center>
                                </tr>

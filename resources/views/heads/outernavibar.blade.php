							...
							<nav id="pageNav" class="navbar navbar-expand-lg order-lg-1">
								...
								<div class="collapse navbar-collapse mainNavCollapse" id="pageMainNavCollapse">
									<ul class="navbar-nav pageMainNavigation justify-content-md-end">
										<li class="nav-item dropdown">
											<a class="nav-link fwMedium text-uppercase dropdown-toggle" href="/" role="button">Home</a>
										...
										<li class="nav-item dropdown">
											<a class="nav-link fwMedium text-uppercase dropdown-toggle" href="/teacherpost"  " aria-haspopup="true" aria-expanded="false">Teacher</a>
											<div class="dropdown-menu mainNavDropdown text-uppercase">
										...
										<li class="nav-item dropdown">
											<a class="nav-link fwMedium text-uppercase dropdown-toggle" href="/studentpost" " aria-haspopup="true" aria-expanded="false">Students</a>
											<div class="dropdown-menu mainNavDropdown text-uppercase">						
												<ul class="list-unstyled navDropdownList">
												</ul>
											</div>
										...
										<li class="nav-item dropdown">
											<a class="nav-link fwMedium text-uppercase dropdown-toggle" href="/aboutus">about us</a>
											<div class="dropdown-menu mainNavDropdown text-uppercase">
											</div>
										</li>
										<li class="nav-item dropdown">
											<a class="nav-link fwMedium text-uppercase dropdown-toggle" href="/contactus" role="button" aria-haspopup="true" aria-expanded="false">Contact us</a>
											<div class="dropdown-menu mainNavDropdown text-uppercase">
											</div>
										</li>
										<li class="nav-item dropdown">

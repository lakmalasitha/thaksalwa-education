...
<body class="grayme">
    ...
    <div class="field ">
        <p class="control has-text-centered is-centered loginbutton">
            <button class="button is-success is full is-uppercase">
                &nbsp; &nbsp; &nbsp; &nbsp; Sign in &nbsp; &nbsp; &nbsp; &nbsp;
            </button>
        </p>
    </div>
    ...
    <div class="column is-one-third rightsideeffect has-background-success">
        <div class="is-mobile textboxlogin textareabox">
            ...
            <p class="subtitle  has-text-white has-text-centered is-size-7 tinytextlogin">Enter your detail and join with us.</p>
